...
---
[Read the next blog post in this series](https://sohumsblog.vercel.app/chat-app-sec-analysis-4), where we implement the Diffie-Hellman key exchange protocol and explore modular arithmetic, computational intractability, man in the middle attacks, message authentication codes, replay attacks and more.
