...
---
[Read the final blog post in this series](http://localhost:3000/blogs/chat-app-sec-analysis-5), where we implement RSA encryption using the Extended Euclidean Algorithm and use it to authenticate messages. We also implement protections against replay attacks.
